---
title: "Introduction to alignfigR"
...
#library(alignfigR)
load_all("/Users/sjspielman/Research/alignfigR")
```
...
my_data <- read_alignment(file = "/Users/sjspielman/Research/alignfigR/data/example.fasta")
```
<br>
...
```{r echo=TRUE, message=FALSE,  fig.height=2.5, fig.width=5.5}
p <- plot_alignment(my_data, "dna")
p
```
