...
exciting_colors <- c("A" = "turquoise", "C" = "maroon", "G" = "cornsilk1", "T" = "mediumpurple1")
plot_alignment(my_data, exciting_colors, column_list = c(552:581), column_action = "restrict", taxon_list = c("Cow", "Carp", "Chicken", "Human"), taxon_action = "restrict" )
```
